...
export default function Curse({ history }, props) {
  ...
  return (
    <div className={Styles.container}>
      <div className={Styles.newsContainer}>
        ...
        <h3>Enterate sobre los cursos que ofrecemos</h3>
                  ...
                  <div className={Styles.cardContainer} key={cursos.id}>
                    ...
                    <div className={Styles.viewMoreButton}>
                      <Button
                        onClick={() =>
                          handleSubmit(
                            (form.courseId = cursos.id),
                            (form.userId = idUser.id)
                          )
                        }
                        variant="outlined"
                        style={{
